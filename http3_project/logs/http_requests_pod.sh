...
make_5g_aka_confirmation_request() {
    ...
    local data='{"resStar":"F7C444CD0F7C7FDD0792217D86EBC1BD"}'

    local cmd="curl -X PUT http://oai-ausf10-svc:80/nausf-auth/v1/ue-authentications/d7fac1ccfd628000b7695ed98cfec7ea/5g-aka-confirmation \
    -d '$data' \
    -H 'Content-Type: application/json' -w '%{time_total}' -o /dev/null -s"
